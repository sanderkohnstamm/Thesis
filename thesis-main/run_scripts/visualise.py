        ...
        for gamma in [0.3]:
            for distance in distances_[:2]:
                for adapt_lr in [lr/2]:
                    ...
                    for delta in [1]:
                        if wandb_:
                            wandb.init(project=f"tno_adaptation_big",
                                        entity="skohnie",
                        ...
                        if vis_errors:
                              func.check_errors(net, test_loader, classes_names, model_paths=[model_path, adaptation_model_path], save=True, device=device)
